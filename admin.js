(function () {
  ...
  function fillEditForm(id) {
    ...
    const shootDate = document.querySelector("[data-edit-shoot-date]");
    if (!zh || !en || !gear || !shootDate) return;
    ...
    shootDate.value = work ? work.shootDate || createdMonth(work.createdAt) : "";
  }
  ...
  if (editForm) editForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      work.shootDate = editForm.querySelector("[data-edit-shoot-date]").value || createdMonth(work.createdAt);
