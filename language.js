  ...
  const translations = {
    zh: {
      ...
      home: {
        ...
        switzerlandLabel: "查看 瑞士·稻田 作品页",
        switzerlandText: "从高空看瑞士田野与地形交织出的安静纹理。",
    ...
    en: {
      ...
      home: {
        ...
        latestFlight: "Latest Flight",
        featuredWork: "Hangzhou Lighthouse",
        aboutEyebrow: "About",
        ...
        switzerlandLabel: "Open Switzerland's Field work page",
        switzerlandText: "A quiet aerial view of Swiss fields and terrain textures.",
